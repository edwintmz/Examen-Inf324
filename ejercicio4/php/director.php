<?php
	...
	try{
        ...
        //desde aqui es para ver el promedio de notas con sql
        $sql = "SELECT departamento, COUNT(notaf) as can, AVG(notaf) as nota FROM persona JOIN inscripcion ON persona.ci = inscripcion.ci GROUP BY departamento"; 
